        ...
        <div className="space-y-3 text-sm tui-muted">
          <div>
            ...
            <div className="text-xs">
              <kbd className="px-1 py-0.5 text-xs font-mono bg-muted rounded border">Ctrl</kbd> + click transaction
            </div>
          </div>
          ...
          <div>
            ...
            <div className="text-xs">
              <kbd className="px-1 py-0.5 text-xs font-mono bg-muted rounded border">Shift</kbd> + click transaction
            </div>
          </div>
          ...
          <div>
            ...
            <div className="text-xs space-y-1">
              <div><kbd className="px-1 py-0.5 text-xs font-mono bg-muted rounded border">Ctrl</kbd> + click day header</div>
              <div><kbd className="px-1 py-0.5 text-xs font-mono bg-muted rounded border">Shift</kbd> + click day header</div>
            </div>
          </div>
        </div>
